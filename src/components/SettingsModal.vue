      ...
      <div class="flex flex-1 overflow-hidden">
        ...
        <div class="flex-1 overflow-auto p-6 scrollbar-thin">
          ...
          <div v-if="activeTab === 'general'" class="space-y-4">
            ...
            <div class="flex items-center justify-between py-3 border-b border-gray-200 dark:border-gray-700" v-if="localConfig.showNotifications">
              <div>
                <div class="text-sm font-medium text-gray-900 dark:text-white">Notification sounds</div>
                <div class="text-xs text-gray-500 dark:text-gray-400">Play sound with notifications</div>
              </div>
              <label class="relative inline-flex items-center cursor-pointer">
                <input type="checkbox" v-model="localConfig.notificationSound" class="sr-only peer">
                <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
              </label>
            </div>
